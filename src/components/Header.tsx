      ...
      <div className="px-6 py-2.5">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              <div>
                ...
                <p className="text-[13px] text-[#86868B] font-medium leading-none">Customer Feedback War Room</p>
              </div>
              ...
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-100">
                <span className="text-[11px] text-[#86868B]">Routing to</span>
                <span className="text-[11px] font-semibold text-[#1D1D1F]">Tom Curtis, CEO</span>
              </div>
            </div>
          </div>
        ...
        <div className="flex items-center justify-end mt-2.5">
          ...
          <div className="flex gap-2.5">
            {/* Total */}
            <div className="stat-card min-w-[100px] px-3 py-2 border border-gray-100" style={{ backgroundColor: 'rgba(142, 142, 147, 0.08)' }}>
              <div className="text-[9px] text-[#86868B] uppercase tracking-widest font-bold mb-1">Total</div>
              <div className="text-[24px] font-bold text-[#1D1D1F] leading-none mb-0.5">{totalComplaints}</div>
              <div className="text-[10px] text-[#86868B] font-medium">messages</div>
            </div>

            {/* Today */}
            <div className="stat-card min-w-[100px] px-3 py-2 border border-blue-100" style={{ backgroundColor: 'rgba(0, 122, 255, 0.08)' }}>
              <div className="text-[9px] text-[#86868B] uppercase tracking-widest font-bold mb-1">Today</div>
              <div className="text-[24px] font-bold text-[#007AFF] leading-none mb-0.5">{todayCount}</div>
              <div className="text-[10px] text-[#86868B] font-medium">new</div>
            </div>

            {/* High Priority */}
            <div className="stat-card min-w-[100px] px-3 py-2 border border-red-100" style={{ backgroundColor: 'rgba(255, 59, 48, 0.08)' }}>
              <div className="text-[9px] text-[#86868B] uppercase tracking-widest font-bold mb-1">Priority</div>
              <div className="text-[24px] font-bold text-[#FF3B30] leading-none mb-0.5 flex items-center gap-1.5">
                {highPriority}
                {highPriority > 0 && <span className="text-[14px] pulse-subtle">🔴</span>}
              </div>
              <div className="text-[10px] text-[#86868B] font-medium">urgent</div>
            </div>

            {/* Avg Anger */}
            <div className="stat-card min-w-[100px] px-3 py-2 border border-orange-100" style={{ backgroundColor: 'rgba(255, 149, 0, 0.08)' }}>
              <div className="text-[9px] text-[#86868B] uppercase tracking-widest font-bold mb-1">Avg Anger</div>
              <div className="text-[24px] font-bold text-[#FF9500] leading-none mb-0.5">{avgAnger}</div>
              <div className="text-[10px] text-[#86868B] font-medium">out of 10</div>
            </div>

            {/* Top Issue */}
            <div className="stat-card min-w-[120px] px-3 py-2 border border-purple-100" style={{ backgroundColor: 'rgba(147, 51, 234, 0.08)' }}>
              <div className="text-[9px] text-[#86868B] uppercase tracking-widest font-bold mb-1">Top Issue</div>
              <div className="text-[15px] font-bold text-[#9333EA] capitalize truncate leading-none mb-0.5">{topCategory}</div>
              <div className="text-[10px] text-[#86868B] font-medium">most common</div>
            </div>
          </div>
        </div>
      </div>
